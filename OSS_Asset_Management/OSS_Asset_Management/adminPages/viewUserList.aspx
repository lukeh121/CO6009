...
<asp:Content ID="Content3" ContentPlaceHolderID="userBodyPlaceHolder" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellSpacing="-1" CssClass="gridUsers" DataSourceID="SqlDataSource1" GridLines="None" OnSelectedIndexChanged="OnSelectedIndexChanged">
        <Columns>
            <asp:CommandField SelectText="Select User" ShowSelectButton="True" />
